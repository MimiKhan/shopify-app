        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              ExpansionTile(
                ...
                title: Row(
                  children: [
                    Text(_isExpanded
                        ? 'Hide Order Summary'
                        : 'Show Order Summary',style: TextStyle(fontSize: 13),),
                    Icon(_isExpanded
                ...
                trailing: Text(
                  checkoutController.checkout.subtotalPriceV2.formattedPrice,
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text(
                                  checkoutController.checkout.currencyCode,
              ...
              const Text('Payment',style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold),),
              const SizedBox(height: 20,),
              const Text('All Payments are secure and encrypted.',
              ...
              ToggleSwitch(
                ...
                icons:[
                  ...
                  Platform.isAndroid ? FontAwesomeIcons.googlePay :
